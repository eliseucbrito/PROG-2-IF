...
public interface SaeInterface {
    ...
    public void changeReserve (String id, int op, String newValue) throws ReserveNotExistsException, EmptyVectorException, TeacherNotFoundException, ReserveNotFoundedException;
